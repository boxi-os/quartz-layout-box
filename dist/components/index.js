...
var ENCODED_PLACEHOLDER = /%7B%7B([\w.\-%20]*?)%7D%7D/gi;
...
function stringify(value) {
  ...
  if (Array.isArray(value)) {
    return value.map(stringify).filter((v) => v !== void 0).join(", ");
  }
  return void 0;
}
    ...
    if (inline !== void 0) {
      ...
      if (!result.ok) {
        ...
        return /* @__PURE__ */ jsxs("div", { class: classNames(displayClass, "layout-box", "layout-box-missing", page.className), children: [
          ...
          ":",
          " ",
          /* @__PURE__ */ jsx("code", { children: path2.relative(process.cwd(), absPath) })
        ] });
      }
      html7 = result.html;
    }
