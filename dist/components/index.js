...
function resolvePlaceholder(name, { fileData, cfg }) {
  ...
  const slug = typeof fileData?.slug === "string" ? fileData.slug : void 0;
  switch (name) {
    case "title":
    ...
    case "slug":
      return slug;
    case "root":
      return slug === void 0 ? void 0 : pathToRoot(slug);
    case "siteTitle":
...
function stringify(value) {
  ...
  if (Array.isArray(value)) {
    return value.map(stringify).filter((v2) => v2 !== void 0).join(", ");
  }
  return void 0;
}
...
function zwitch(key2, options) {
  ...
  function one5(value, ...parameters) {
    ...
    if (value && own4.call(value, key2)) {
      ...
      fn = own4.call(handlers2, id) ? handlers2[id] : one5.unknown;
    }
    if (fn) {
...
var serializer = (strict, json, $3, _2) => {
  const as = (out, value) => {
...
var one3 = zwitch("type", { handlers: { root: root3, element: element2, text: text6, comment, doctype } });
...
function aaObtainFurthestBlock(p3, formattingElementEntry) {
  ...
  for (; idx >= 0; idx--) {
    const element5 = p3.openElements.items[idx];
    if (element5 === formattingElementEntry.element) {
      break;
    }
    if (p3._isSpecialElement(element5, p3.openElements.tagIDs[idx])) {
...
function endTagInForeignContent(p3, token) {
  ...
  for (let i2 = p3.openElements.stackTop; i2 > 0; i2--) {
    ...
    const tagName = p3.treeAdapter.getTagName(element5);
...
function raw(tree, options) {
  ...
  const one5 = zwitch("type", {
    handlers: { root: root4, element: element3, text: text7, comment: comment2, doctype: doctype2, raw: handleRaw },
    unknown
  });
  const state = {
...
function html5(_2, index2, parent) {
...
function text8(node2, _2, parent, state) {
...
var handle2 = zwitch("type", {
  invalid,
  unknown: unknown2,
  handlers: { comment: comment3, doctype: doctype3, element: element4, raw: raw2, root: root5, text: text8 }
});
...
// src/markdown.ts
var processor = unified().use(remarkParse).use(remarkGfm).use(remarkRehype, { allowDangerousHtml: true }).use(rehypeRaw).use(rehypeStringify);
...
function resolveSnippetPath(dir, file) {
  const baseDir = default2.resolve(process.cwd(), dir);
  const absPath = default2.resolve(baseDir, file);
  const rel = default2.relative(baseDir, absPath);
  if (rel === "" || rel.startsWith("..") || default2.isAbsolute(rel)) {
...
function readSnippet(absPath) {
  ...
  let raw3;
  try {
    raw3 = fs.readFileSync(absPath, "utf-8");
  } catch (error) {
    return { ok: false, reason: `Could not read snippet file (${String(error)})` };
  }
  const html7 = absPath.toLowerCase().endsWith(".md") ? renderMarkdown(raw3) : raw3;
  snippetCache.set(absPath, { mtimeMs, html: html7 });
  return { ok: true, html: html7 };
}
function readFrontmatterControl(frontmatter, key2) {
  if (!frontmatter || typeof frontmatter !== "object") return {};
  const value = frontmatter[key2];
  ...
  const LayoutBox = (props) => {
    ...
    if (inline !== void 0) {
      ...
      if (!result.ok) {
        ...
        return /* @__PURE__ */ u2("div", { class: classNames(displayClass, "layout-box", "layout-box-missing", opts.className), children: [
          "Layout Box: ",
          result.reason.toLowerCase(),
          ":",
          " ",
          /* @__PURE__ */ u2("code", { children: default2.relative(process.cwd(), absPath) })
        ] });
      }
      html7 = result.html;
    }
    ...
    const content3 = /* @__PURE__ */ u2("div", { class: "layout-box-content", dangerouslySetInnerHTML: { __html: html7 } });
    if (opts.collapsible && opts.title) {
      return /* @__PURE__ */ u2("details", { class: boxClass, open: !opts.collapsed, children: [
        /* @__PURE__ */ u2("summary", { class: "layout-box-title", children: opts.title }),
        content3
      ] });
    }
    return /* @__PURE__ */ u2("div", { class: boxClass, children: [
      opts.title && /* @__PURE__ */ u2("h3", { class: "layout-box-title", children: opts.title }),
      content3
    ] });
  };
  LayoutBox.css = layout_box_default;
  return LayoutBox;
});

export { LayoutBox_default as LayoutBox };
